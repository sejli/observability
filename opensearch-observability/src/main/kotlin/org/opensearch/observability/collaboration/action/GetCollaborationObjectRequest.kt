 ...
 */
class GetCollaborationObjectRequest : ActionRequest, ToXContentObject {
    val objectIds: Set<String>
    val types: EnumSet<CollaborationObjectType>
    val fromIndex: Int
    val maxItems: Int
    ...
    companion object {
        private val log by logger(GetCollaborationObjectRequest::class.java)

        /**
         * reader to create instance of class from writable.
         */
        val reader = Writeable.Reader { GetCollaborationObjectRequest(it) }
        ...
        fun parse(parser: XContentParser): GetCollaborationObjectRequest {
            ...
            while (parser.nextToken() != XContentParser.Token.END_OBJECT) {
                ...
                when (fieldName) {
                    ...
                    OBJECT_TYPE_FIELD -> fromIndex = parser.intValue()
                    ...
                    FILTER_PARAM_LIST_FIELD -> filterParams = parser.mapStrings()
                        ...
                        parser.skipChildren()
                        log.info("Unexpected field: $fieldName, while parsing GetCollaborationObjectRequest")
                    }
                }
            }
            return GetCollaborationObjectRequest(
                objectIdList,
                types,
                fromIndex,
                maxItems,
    ...
    constructor(
        ...
        types: EnumSet<CollaborationObjectType> = EnumSet.noneOf(CollaborationObjectType::class.java),
        fromIndex: Int = 0,
    ...
    constructor(input: StreamInput) : super(input) {
        ...
        types = input.readEnumSet(CollaborationObjectType::class.java)
